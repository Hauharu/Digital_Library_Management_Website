...
Revision ID: 5fdcca019f85
Revises: 5b2c895c8ca9
Create Date: 2026-04-23 17:40:21.084797
...
revision = '5fdcca019f85'
down_revision = '5b2c895c8ca9'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('sent_date', mysql.DATETIME(), nullable=True),
    sa.Column('user_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('book_id', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('id', mysql.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('created_at', mysql.DATETIME(), nullable=True),
    sa.Column('updated_at', mysql.DATETIME(), nullable=True),
    sa.ForeignKeyConstraint(['book_id'], ['book.id'], name=op.f('message_ibfk_2')),
